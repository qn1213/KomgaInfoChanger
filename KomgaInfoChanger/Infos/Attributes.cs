...
{    
    ...
    {//title;      // => 제목
        ...
        public Dictionary<string, List<string>> artist;     // => 작가(2명 이상 참여작일 때), Role은 Artist로 하드코딩할 예정
        public Dictionary<string, List<string>> group;      // => 그룹
        public Dictionary<string, string> type;       // => 타입 (동인지, 기타 등등)
        public Dictionary<string, List<string>> series;     // => 시리즈
